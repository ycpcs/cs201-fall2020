...
-   [Java Development Kit](https://jdk.java.net/14/): This is required to run Java programs. Make sure you download the JDK, not the JRE.  Make sure you get version 1.8 or later.
