...
**Due**: Monday, Sept 28th by 11:59 PM

Acknowledgment: The idea for this assignment comes from [Tom Ellman](http://pages.vassar.edu/tomellman/) at Vassar College.

## Getting Started

Download [CS201\_Assign03\_Gradle.zip](CS201_Assign03_Gradle.zip). Extract the zip file and **copy** your completed **Disk.java** file from  **CS201\_Assign02\_Gradle/src/main/java** to **CS201\_Assign03\_Gradle/src/main/java**.
...
If you have the [Simple Marmoset Uploader Plugin](../resources/index.html) installed, then right click on the project (**CS201\_Assign03\_Gradle**) and choose **Submit project...**. Enter your Marmoset username and password when prompted.

### From a web browser

Save the project (**CS201\_Assign03\_Gradle**) to a zip file by right-clicking it and choosing
